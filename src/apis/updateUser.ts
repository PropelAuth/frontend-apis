...
// import { ErrorCode, ApiErrorResponse, UnauthorizedResponse, UnexpectedErrorResponse } from '../helpers/errors'
...
// /////////////////
// export interface UpdateUserBadRequestResponse<V extends Visitor> extends ApiErrorResponse<V> {
